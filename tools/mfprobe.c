...
static const probe_format_t VIDEO_FORMATS[] = {
    { &MFVideoFormat_H264,  "H.264 (AVC)",      "Modern video" , false },
    { &MFVideoFormat_HEVC,  "H.265 (HEVC)",     "Modern video" , false },
    { &MFVideoFormat_VP80,  "VP8",              "Modern video" , false },
    { &MFVideoFormat_VP90,  "VP9",              "Modern video" , false },
    { &MFVideoFormat_AV1,   "AV1",              "Modern video" , false },
    { &MFVideoFormat_MPG1,  "MPEG-1 video",     "Broadcast & legacy" , false },
    { &MFVideoFormat_MPEG2, "MPEG-2 video",     "Broadcast & legacy" , false },
    { &MFVideoFormat_MP4V,  "MPEG-4 ASP (DivX/XviD)", "Broadcast & legacy" , false },
    { &MFVideoFormat_H263,  "H.263",            "Broadcast & legacy" , false },
    { &MFVideoFormat_DVSD,  "DV",               "Broadcast & legacy" , false },
    { &MFVideoFormat_WMV3,  "WMV3 (WMV 9)",     "Windows Media" , false },
    { &MFVideoFormat_WVC1,  "VC-1 Advanced",    "Windows Media" , false },
    { &MFVideoFormat_MJPG,  "Motion JPEG",      "(extra)" , false },
    { &RV_MFVideoFormat_Theora, "Theora",       "Ogg open media" , false },
};

static const probe_format_t AUDIO_FORMATS[] = {
    { &MFAudioFormat_AAC,             "AAC",            "Compressed audio" , false },
    { &MFAudioFormat_MP3,             "MP3",            "Compressed audio" , false },
    { &MFAudioFormat_WMAudioV9,       "WMA v9",         "Compressed audio" , false },
    { &MFAudioFormat_WMAudio_Lossless,"WMA Lossless",   "Compressed audio" , false },
    { &MFAudioFormat_FLAC,            "FLAC",           "Lossless audio" , false },
    { &MFAudioFormat_ALAC,            "Apple Lossless", "Lossless audio" , false },
    { &MFAudioFormat_PCM,             "PCM (WAV)",      "Lossless audio", true },
    { &MFAudioFormat_Vorbis,          "Ogg Vorbis",     "Ogg open media" , false },
    { &MFAudioFormat_Opus,            "Opus",           "Ogg open media" , false },
    { &MFAudioFormat_Dolby_AC3,       "Dolby AC-3",     "(extra)" , false },
    { &MFAudioFormat_DTS,             "DTS",            "(extra)" , false },
};
