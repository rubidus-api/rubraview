...
**Rubraview v0.0.5** (latest release) download — [rubraview-v0.0.5.zip (Windows 11 x64)](https://github.com/rubidus-api/rubraview/releases/download/v0.0.5/rubraview-v0.0.5.zip) · [all releases](https://github.com/rubidus-api/rubraview/releases)
...
Unzip and run `rubraview-v0.0.5.exe`: there is no installer and nothing to place beside it. FFmpeg's DLLs are the one exception, and only for the formats Media Foundation cannot open.
