...
```
dist/rubraview-v0.0.5.exe              the viewer
dist/rubraview-mfprobe-v0.0.5.exe      a tool that reports which video
                                       formats your Windows can play
dist/rubraview-v0.0.5/                 the release bundle — zip this
```
...
`rubraview-v0.0.5.exe` — so that a copy sitting in a downloads folder
