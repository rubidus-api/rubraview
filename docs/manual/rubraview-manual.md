...
```
dist/rubraview-v0.0.10.exe              the viewer
dist/rubraview-mfprobe-v0.0.10.exe      a tool that reports which video
                                       formats your Windows can play
dist/rubraview-v0.0.10/                 the release bundle — zip this
```
...
`rubraview-v0.0.10.exe` — so that a copy sitting in a downloads folder
