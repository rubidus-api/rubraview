...
| T063 | R146, R135 | settings.ini is read at startup, not only when the settings window opens: subtitle size and outline take effect on the first frame | `make package`, put a settings.ini beside the executable, run on Windows | docs/tests/cases/T063-settings-from-startup.md | manual |
