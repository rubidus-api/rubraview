...
| T055 | R129 | Ask a Windows machine which media formats it can decode without FFmpeg, and whether it can open real files | `make mfprobe` then run `dist/mfprobe.exe` on Windows | docs/tests/cases/T055-media-foundation-probe.md | manual |
