...
SRCS_CORE = src/core/number.c src/core/subbox.c src/core/thumb.c src/core/thumbq.c src/core/pixbuf.c src/core/color.c src/core/resample.c src/core/filter.c src/core/path.c src/core/sort.c \
...
TEST_BINS = build/tests/test_pixbuf build/tests/test_color build/tests/test_resample build/tests/test_filters build/tests/test_path build/tests/test_number build/tests/test_subbox build/tests/test_thumb build/tests/test_thumbq build/tests/test_sort \
