...
static const expected_t EXPECTED[] = {
    ...
    { "audio", "gapless", RUBRAVIEW_SETTING_BOOL, RUBRAVIEW_TAB_AUDIO, 1.0, 0.0, 1.0, 1.0, "", true },
    { "audio", "crossfade_seconds", RUBRAVIEW_SETTING_FLOAT, RUBRAVIEW_TAB_AUDIO, 0.0, 0.0, 5.0, 0.1, "", true },
    ...
    { "audio", "bgm_pause_on_video", RUBRAVIEW_SETTING_BOOL, RUBRAVIEW_TAB_AUDIO, 1.0, 0.0, 1.0, 1.0, "", true },
    ...
    { "ui", "toolbox_opacity", RUBRAVIEW_SETTING_INT, RUBRAVIEW_TAB_DISPLAY, 90.0, 30.0, 100.0, 5.0, "", true },
